...
$(document).ready(function() {
     ...
     * 過去データを調整
     */
    $('.js-data-modify').on('click', function() {
...
function searchLibraries(pref, city) {
    ...
    //xhr.open("GET", 'https://api.calil.jp/library?appkey='+apiKey+'&pref='+pref+'&format=xml', true);
    xhr.open("GET", 'https://api.calil.jp/library?appkey=' + apiKey + '&pref=' + pref + '&city=' + city + '&format=xml', true);
    xhr.send();
